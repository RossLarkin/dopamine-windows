...
namespace Dopamine.ViewModels.Common
{
    public class EditTrackViewModel : EditMetadataBase
    {
        ...
        private async Task GetFilesMetadataAsync()
        {
            ...
            {
                Tracer.Error("An error occurred while getting the metadata from the files. Exception: {0}", ex.Message);
            }
            ...
            await Task.Run(() =>
            {
                ...
                {
                    Tracer.Error("An error occurred while parsing the metadata. Exception: {0}", ex.Message);
                }
            });
        }
        ...
        public async Task<bool> SaveTracksAsync()
        {
            ...
            await Task.Run(() =>
            {
                ...
                {
                    Tracer.Error("An error occurred while setting the metadata. Exception: {0}", ex.Message);
                }
            });
